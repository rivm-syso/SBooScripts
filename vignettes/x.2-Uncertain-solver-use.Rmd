...
#TODO provide definition of function variables.
...
Now we are ready to prepare the variable data and define the min, max and mode of the distribution for each variable. 
...
In the chunk below, the name, scale, subcompartment, min, max and mode are defined for each variable.

```{r Get min, max and mode of variable values, warning=FALSE, message=FALSE}
...
min, max and mode values if you have them.
...
```{r Get min, max and mode of variable values 2, warning=FALSE, message=FALSE}
# Define the names of the uncertain variables
var1Name <- "Area"
