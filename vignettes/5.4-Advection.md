...
different contributors to continental discharge. These are: Runoff (see
description in section [7.3
OtherIntermedia](vigenttes/7.3%20OtherIntermedia.md)) and
...
for Cont. Scale). The rest of the freshwater is discharged to
continental sea.
...
```
    ...
    ## function (ScaleName, SubCompartName, all.RunoffFlow, all.RainOnFreshwater, 
    ##     dischargeFRAC) 
    ## {
    ##     switch(ScaleName, Continental = {
    ##         switch(SubCompartName, river = {
    ##             SumRainRunoff <- sum(all.RunoffFlow$RunoffFlow[all.RunoffFlow$Scale == 
...
```
    ...
    ## Warning in private$FetchData(varname): Cannot find property Runoff ; but found
    ## RunoffFlow k_Runoff
...
```
    ...
    ## 16 Continental       lake        193.43671
    ## 21 Continental      river       2127.80378
    ## 38    Regional       lake         12.68384
    ## 43    Regional      river        139.52221
...
```
    ...
    ## function (all.RunoffFlow, all.RainOnFreshwater, dischargeFRAC, 
    ##     all.x_ContRiver2Reg, ScaleName, SubCompartName) 
    ## {
...
```
    ...
    ## function (RainOnFreshwater, all.RunoffFlow, FracROWatComp, SubCompartName, 
    ##     ScaleName) 
    ## {
    ##     switch(SubCompartName, lake = {
    ##         SumRunoff <- sum(all.RunoffFlow$RunoffFlow[all.RunoffFlow$Scale == 
    ##             ScaleName])
    ##         return(RainOnFreshwater + FracROWatComp * SumRunoff)
    ##     }, NA)
    ## }
    ## <bytecode: 0x00000215d94564d8>
...
```
    ...
    ## 11 Continental agriculturalsoil    0.600
    ## 16 Continental             lake    0.005
    ## 19 Continental      naturalsoil    0.270
    ## 20 Continental        othersoil    0.100
    ## 21 Continental            river    0.025
    ## 33    Regional agriculturalsoil    0.600
    ## 38    Regional             lake    0.005
    ## 41    Regional      naturalsoil    0.270
    ## 42    Regional        othersoil    0.100
    ## 43    Regional            river    0.025
...
```
    ...
    ##    FlowName   fromScale     toScale fromSubCompart toSubCompart      flow
    ## 6 x_LakeOut    Regional    Regional           lake        river  115.2115
    ## 7 x_LakeOut Continental Continental           lake        river 1757.0501
...
```
    ...
    ##         FlowName   fromScale  toScale fromSubCompart toSubCompart     flow
    ## 24 x_ContSea2Reg Continental Regional            sea          sea 12442.84
...
```
    ...
    ##         FlowName fromScale     toScale fromSubCompart toSubCompart     flow
    ## 25 x_RegSea2Cont  Regional Continental            sea          sea 13825.38
...
```
    ...
    ## 29 x_ToModerateWater Continental Moderate            sea          sea  23536466
...
```
    ...
    ##    <chr>                      <dbl>          <dbl>        <dbl>            <dbl>
    ##  1 Regional.river              115.            NA           NA               NA 
    ##  2 Regional.sea                 NA           1383.          NA               NA 
    ##  3 Continental.sea              NA             NA        13825.              NA 
    ##  4 Continental.river            NA             NA           NA             1757.
...
```
    ...
    ## k_Advection.22         river   Unbound 2.016214e-09
    ## k_Advection.26           sea   Unbound 7.331688e-08
    ## k_Advection.31           air   Unbound 1.381786e-06
    ## k_Advection.33           sea   Unbound 3.169118e-08
    ## k_Advection.39           air   Unbound 3.003899e-07
    ## k_Advection.43         river   Unbound 0.000000e+00
    ## k_Advection.45           sea   Unbound 1.675393e-11
    ...
    ## k_Advection.67           sea   Unbound 6.068353e-09
    ...
    ## k_Advection.93           sea   Unbound 1.382538e-06
    ## k_Advection.98         river   Unbound 2.016214e-09
    ## k_Advection.101          sea   Unbound 7.331688e-08
