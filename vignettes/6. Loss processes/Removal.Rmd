...
-   One v_Tempfactor (inclusief air?) *OK I will have a try/look*

-   One kdeg in SubstanceCompart, verwijderen uit kdeg.xxx uit Substance *What do you mean? one kdeg? It will always depend on the substance, is it not easier to have kdeg in the substance database, like it is/was in SimpleBox xlsx and in the database as we have it? Makes more sense to me, we also do not put ksw or thers in SubstanceCompart no? Is this something new?*

-   One v_degradation waarbij data wordt gebruikt als aanwezig anders de European Commission, 2003a benadering. *Why? So we will not use A k for degradation? The EU comission approach is what is implemented in f_kdegcalc. I can have a try to make this work*

-   How does v_degradation work for particles? *This is also through 'particle' or substance measured data*
