...
This can or should be adjusted when more specific data is available on the land surface area contributing to the upstream (w0) versus downstream (w1) Runoff <!--# No link with data layer implemented yet, e.g. introducing a data variable (e.g. RunoffFrac) from data and if NA calculated from compFrac and waterFrac -->.
