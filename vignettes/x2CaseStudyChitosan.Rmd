...
SBtime <- seq(0,365.25*24*60*60*1,length.out = 1*12)
...
To move from the solution of the ODE solver to usable output data we need to split the output into corresponding mass data per compartment over time and emission signals over time.

```{r Output Processing }
Solution <- as.data.frame(out)
print(NamesK)
print(length(NamesK))
