...
for (i in seq_along(file_paths)) {
  ...
  # Create a new dataframe with the averages, convert from tonnes to kg
...
Below you can create a plot for one output, after that to represent uncertainty based on multiple outputs
