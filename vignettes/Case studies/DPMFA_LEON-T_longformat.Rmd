...
materials <- unique(DPMFA_sink_micro$Polymer)
...
suppressWarnings({
  var_df <- explodeF(Material_Parameters, target_col = "Polymer", explode_value = "any", new_values = materials)
})
