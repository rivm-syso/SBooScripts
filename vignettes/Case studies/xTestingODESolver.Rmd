...
SolutionConstantEmissions <- SBsolve4(tmax = 25*(365.25*24*3600),
  nTIMES = 25,
...
```
<!-- Trial with events, probably not to be used. -->
...
print(compartment_prefixes_combined_scale)
...
print(compartment_prefixes_combined)
