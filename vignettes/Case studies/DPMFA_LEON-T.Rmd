...
- The mean width of road side soil
...
road_length_EU <- 4852242 # Total Road length (km) EU in 2013, will try to find a more recent source
RL_km <- road_length_EU*1000
...
if(type == "PMFA"){
  for(name in solved_df_names){
    ...
    for (scale in scales) {
      ...
      ggsave(paste0("R:/Projecten/E121554 LEON-T/03 - uitvoering WP3/Deliverable 3.5/Figures/Mass_plot_", scale,  "_", dt, "_", runs, "runs.png"), plot=mass_p)
    }
  }
} else if(type == "DPMFA"){
  for(name in solved_df_names){
...
if(type == "PMFA"){
  for(name in concentration_df_names){
    ...
    for (scale in scales) {
      ...
      ggsave(paste0("R:/Projecten/E121554 LEON-T/03 - uitvoering WP3/Deliverable 3.5/Figures/Concentration_plot_", scale, "_", "_", runs, "runs.png"), plot=conc_p)
    }
  }
} else if(type == "DPMFA"){
  for(name in solved_df_names){
