---
"2026-02-25" output: github_document editor_options: chunk_output_type: console
...
\- When the **Test_surface_water** variable is set to TRUE, the deepocean subcompartment at Regional and Continental scale is introduced.
...
\- Compare marine_currents_clean with Remove_global = TRUE and Test_surface_water = TRUE to development branch

\- Compare marine_currents_clean with Remove_global = FALSE and Test_surface_water = FALSE to development.
