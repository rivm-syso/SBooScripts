...
diagonal$from[!diagonal$from %in% diagonal_excel\$from] [1] "s2A" "s2M"
"s2T" "s3A" "s3M" "s3T" "sd0A" "sd0C" "sd0M" "sd0R" "sd0T" "sd1A" "sd1M"
"sd1T" "w0A" "w0M" "w0T" "w1A" "w1M" "w1T" [21] "w3C" "w3R"
...
SBexcel.K$fromto[!SBexcel.K$fromto %in% kaas2$fromto] #9 missing: "sM_w2M"  "w3M_sdM" "aM_sM"   "sA_w2A"  "w3A_sdA" "aA_sA"   "sT_w2T"  "w3T_sdT" "aT_sT"  
...
1.  The Fringas in excel had an error, was using variables from Moderate
    scale, fix in Excel.
