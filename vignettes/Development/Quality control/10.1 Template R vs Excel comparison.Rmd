...
# for an accurate comparison between excel and R. 
...
air <- kaas |>
  ...
  filter(fromScale == "Tropic")

# The difference between the diagonals for the air compartment is in k_Degradation. The variable 'KdegDorC' is used to calculate this K, but in R the value is rounded while in excel it is not. Rounding this value in excel solved the problem. 
...
soil <- kaas |>
  ...
  filter(toSubCompart == "naturalsoil") |>
