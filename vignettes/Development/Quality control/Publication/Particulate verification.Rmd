...
all kdeg rates were changed from 0 to 1e-20, and all kdis rates were changed from their original values to 0. 

```{r Test TRUE, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
SBExcelName <- paste0("vignettes/Development/Quality control/SBExcel/SimpleBox4plastics_rev009-1_",substance,"_copy.xlsx") 
