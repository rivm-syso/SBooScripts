...
```
    ...
    ##  [1] "k_Burial"                  "k_Escape"                 
    ##  [3] "k_Fragmentation"           "k_Erosion"                
    ##  [5] "k_HeteroAgglomeration.a"   "k_HeteroAgglomeration.wsd"
    ##  [7] "k_Resuspension"            "k_CWscavenging"           
    ##  [9] "k_DryDeposition"           "k_WetDeposition"          
    ## [11] "k_Degradation"             "k_Leaching"               
    ## [13] "k_Runoff"                  "k_Sedimentation"          
    ## [15] "k_Advection"
...
```
    ...
    ##  [4] "air"                "naturalsoil"        "sea"               
    ##  [7] "agriculturalsoil"   "lake"               "othersoil"         
    ## [10] "river"              "deepocean"          "cloudwater"
