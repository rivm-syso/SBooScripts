...
```{r PlotsDiagonalk_1, fig.cap="Figure 1: Relative differences removal k's between R and excel", echo=FALSE, warning=FALSE}
...
Figure1 <- ggplot(sorted_diff, aes(x = from, y = reldif)) +
  geom_boxplot() +
