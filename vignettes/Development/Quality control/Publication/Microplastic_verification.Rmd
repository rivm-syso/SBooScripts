...
substance is `r``World$fetchData("Substance")`, which has a default
...
### Steadystate mass
```{r comparison of steady state emissions using SB1Solve, include= TRUE, echo= FALSE, warning=FALSE, fig.cap="Figure 6: Relative differences in steady state mass per compartment between R (SB1solve) and Spreadsheet implementation of SimpleBox (Test=TRUE)"}
