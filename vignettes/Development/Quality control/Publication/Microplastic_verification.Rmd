...
```{r PlotsDiagonalk_1, echo=FALSE, warning=FALSE}

#|fig.cap = "Figure 1: Relative differences sum of from-k's between SimpleBox implemented in R and spreadsheet for paste0(substance)"
...
As can be seen in Figure 2 above, the only relative differences larger than 0.1% are between
