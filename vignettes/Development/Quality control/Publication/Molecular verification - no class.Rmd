---
title: "Molecular verification - neutral and no class"
author: "Anne Hids"
date: "`r Sys.Date()`"
...
version of Simplebox for a substance with a neutral class or without a class, as
the processes for these classes are the same.
...
As can be seen in Figure 2, relative differences larger than 0.001 are in the lake and
...
The difference the diagonal k's for sedimentation comes from a difference in k's for the 
...
and resuspension processes (explained abovo under 'Settling velocity') also solves these differences.
