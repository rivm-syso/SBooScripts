...
# SBooscripts
SBScriptsLink_test <- "https://github.com/rivm-syso/SBooScripts/archive/refs/heads/Fluxwork.zip"
SBScriptsLink_Release <- "https://github.com/rivm-syso/SBooScripts/archive/refs/tags/2025.04.0.zip"

SBooLink_test <- "https://github.com/rivm-syso/SBoo/archive/refs/heads/FLuxwork.zip"
SBooLink_Release <- "https://github.com/rivm-syso/SBoo/archive/refs/tags/2025.04.0.zip"

dest_file_SBScripts_test <- "C:/Temp/SBtest/SBooScripts.zip"
dest_file_SBScripts_Release <- "C:/Temp/SBmain/SBooScripts.zip"
dest_file_SBoo_test <- "C:/Temp/SBtest/SBoo.zip"
dest_file_SBoo_Release <- "C:/Temp/SBmain/SBoo.zip"

if(!dir.exists(str_sub(dest_file_SBScripts_test,1,-17))){
  dir.create(str_sub(dest_file_SBScripts_test,1,-17))
}
if(!dir.exists(str_sub(dest_file_SBScripts_Release,1,-17))){
  dir.create(str_sub(dest_file_SBScripts_Release,1,-17))
}
if(!dir.exists(dest_folder)){
  dir.create(dest_folder)
}
zips_folder <- "C:/Temp/SBzips"
if(!dir.exists(zips_folder)){
  dir.create(zips_folder)
}
download.file(SBScriptsLink_test,paste0(zips_folder,"/zip1.zip"))
download.file(SBScriptsLink_Release,paste0(zips_folder,"/zip2.zip"))
download.file(SBooLink_test,paste0(zips_folder,"/zip3.zip"))
download.file(SBooLink_Release,paste0(zips_folder,"/zip4.zip"))


CompareFilesPrep <- function(Release_SB = "2025.04.0",
                             Test = "Fluxwork",
                             Temp_Folder = "C:/Temp" # an existing folder
){
  SBScriptsLink_test <- 
    paste0("https://github.com/rivm-syso/SBooScripts/archive/refs/heads/",Test,".zip")
  SBScriptsLink_Release <- 
    paste0("https://github.com/rivm-syso/SBooScripts/archive/refs/tags/",Release,".zip")
  
  SBooLink_test <- 
    paste0("https://github.com/rivm-syso/SBoo/archive/refs/heads/",Test,".zip")
  SBooLink_Release <- 
  ...
  download.file(SBScriptsLink_test,paste0(Temp_Folder,"/SBzips/SBooScripts_",Test,".zip"))
  download.file(SBooLink_test,paste0(Temp_Folder,"/SBzips/SBoo_",Test,".zip"))
...
system("git remote get-url origin")  # Ensure the branch is up-to-date
