...
```{R Run SB and get output data, echo=TRUE, message=FALSE, warning=FALSE}
# Change the wd to the wd of the main branches
...
```{R Comparison of rate constants, results ="hide", echo=TRUE, message=FALSE, warning=FALSE}
...
concentrations in lake sediment and lake water, up to
`r max(con_solution_comparison$rel_diff)*100` %.
