---
title: "Model Quality and Transparency document"
date: "`r Sys.Date()`"
author: "Matthias Hof, Jaap Slootweg, Joris Quik, et al."
output: github_document
---

This document provides an overview of information required to assess the quality of SimpleBox according to the RIVM quality framework "Quality and Transparancy of Models".
The current information of this document relates to version 2024.8.0.
...
|                        |                                                                     |
|                        | -   Re-evaluation of model parameters at each timestep for dynamics |
|                        |                                                                     |
...
![Figure 2. Schematic overview of the SimpleBox Object Oriented stucture](images/SBoo_Overview.png)
...
-   [10.0 Solver use](vignettes/10.0-Solver_use.md) : explains how to solve for both static and dynamic data.
