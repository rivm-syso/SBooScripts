---
title: "Development of SimpleBox object oriented (SBoo)"
date: "`r Sys.Date()`"
...
-   Verification vignette's in the [Quality Control folder](/vignettes/Development/Quality%20control). For now these are based on a comparison with the Excel version of Excel. This will be updated in the future, see [Issue 207](https://github.com/rivm-syso/SBoo/issues/207).
