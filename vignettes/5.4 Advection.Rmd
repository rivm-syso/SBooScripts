...
OtherIntermedia](vigenttes/7.3 OtherIntermedia.md)) and RainOnFreshwater
for both freshwater compartments (w0 and w1). In the default scenario
where the regional scale coincides with a watershed this is 0, but when
e.g. country boundaries are taken this becomes relevant as there could
be inflow of freshwater across the border. The main driving variable is
'dischargeFRAC' which indicates the fraction of freshwater outflow at
continental scale flowing to regional scale (set for Cont. Scale). The
rest of the freshwater is discharged to continental sea.
