...
continental to regional soil. This fucnction also depends on the
different contributors to continental discharge. These are: Runoff,
RainOnFreshwater and Lake2River. calculates the flow from contintental
...
World$fetchData("ScaleName")
World$fetchData("x_LakeOutflow")
flow = World$NewCalcVariable("x_LakeOutflow")
flow$execute()
