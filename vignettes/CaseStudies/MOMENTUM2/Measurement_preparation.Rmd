...
SB4P <- SB4P_raw |>
  ...
  rename(value = mean) |>
  select(subcompartment, min_diameter_um, max_diameter_um, value, unit, source, method, location) |>
...
data <- bind_rows(SB4P, KWR_data) |>
  select(value, unit, subcompartment, subcompartment, location, min_diameter_um, max_diameter_um, mean_diameter_um, median_diameter_um, sampling_method, detection_method, lower_detection_limit_um, upper_detection_limit_um, source, institute) |>
  rename(concentration = value,
         concentration_unit = unit)

write.xlsx(data, "Measurements_MP_surface_water.xlsx")
```
