...
```{r}
# run the script:
source("vignettes/CaseStudies/03ff_get_solution_FateFactors.R")
...
BatchFiles <- list.files("vignettes/CaseStudies/BatchFiles")

for(Bfile in BatchFiles){
  source(paste0("vignettes/CaseStudies/BatchFiles/",Bfile))
}
...
source("vignettes/CaseStudies/05_SimpleBox_figures_D3.5.R")
...
source("vignettes/CaseStudies/06_save_emission_figure_data.R")
...
source("vignettes/CaseStudies/08_emission_figures_D3.5.R")
