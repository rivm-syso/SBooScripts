...
substance <- "BENSULFURON-METHYL (PH7)"
...
#Emissie Dataframe
#maakt df met POPE emissies voor 70 jaar, script vult nu nog aan met 70 lege jaren
#dit werkt niet wachten op nieuwe solver
source("~/R files/SBooScripts/testScripts/EmissionModel.R")
```
...
regional_plot <- plot_scale(solved_long, "Regional", list("river", "naturalsoil", "agriculturalsoil", "othersoil", "air"))
print(regional_plot)
```
