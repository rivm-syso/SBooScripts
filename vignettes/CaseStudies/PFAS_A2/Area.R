...
#shapefiles inladen
RhineNL <- st_read("/data/BioGrid/quikj/PFAS_A2/GIS/RhineNL.shp", quiet = TRUE)
RhineEU <- st_read("/data/BioGrid/quikj/PFAS_A2/GIS/RhineEU.shp", quiet = TRUE)
MeuseNL <- st_read("/data/BioGrid/quikj/PFAS_A2/GIS/MeuseNL.shp", quiet = TRUE)
MeuseEU <- st_read("/data/BioGrid/quikj/PFAS_A2/GIS/MeuseEU.shp", quiet = TRUE)
