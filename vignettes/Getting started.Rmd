...
### Model Output
For now the most reliably is to output masses and manually calculate concentrations and other relevant output based on your needs [5-12-2024].
We are working on the Concentration module and have output of the mass flows and mass balance in preparation.
