...
Before starting, set your working directory to the SBooScripts folder.
...
solved_long_regional <- solved_long |>
  filter(str_detect(Abbr, "R"))

solved_long_continental <- solved_long |>
  filter(str_detect(Abbr, "C"))

```

## Plot the dynamic masses

```{r}
# Plot masses on regional scale
mass_plot_regional <- ggplot(solved_long_regional, aes(x=Year, y=Mass, col=Abbr)) + 
  geom_line() +
  ylab("Mass (kg)") +
  theme_bw() +
  ggtitle("Masses over time at regional scale")

mass_plot_regional

# Plot masses on continental scale
mass_plot_continental <- ggplot(solved_long_continental, aes(x=Year, y=Mass, col=Abbr)) + 
  geom_line() +
  ylab("Mass (kg)") +
  theme_bw()  +
  ggtitle("Masses over time at continental scale")

mass_plot_continental
