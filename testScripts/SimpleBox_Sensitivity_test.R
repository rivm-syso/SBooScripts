...
for (i in seq(nrow(UncertParams))) {
  ...
  if (SubstanceCount > 0) {
    cat(SubstanceCount, "more params left to go. Estimated time left:", time.taken*SubstanceCount, "\n")
  }
  else {
    cat("Done\n")
  }
